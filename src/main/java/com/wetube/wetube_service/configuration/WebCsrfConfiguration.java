...
public class WebCsrfConfiguration {
    ...
    public RequestMatcher csrfIgnoringRequestMatcher() {
        ...
        return new OrRequestMatcher(
                ...
                new RegexRequestMatcher("^/api/ai-editor(/.*)?$", null)
